...
public class MainMapReduce3 {
	public static void main(String[] args) throws Exception {

		Configuration conf = new Configuration();
		Job job1 = new Job(conf, "tickerYearFirstLastClose");

		job1.setJarByClass(MainMapReduce3.class);
		...
		job2.setJarByClass(MainMapReduce3.class);
		...
		job3.setJarByClass(MainMapReduce3.class);

		job3.setReducerClass(ReduceName.class);
		job3.setMapperClass(MapName.class);
		...
		Job job4 = new Job(conf, "reduceCoppie");
		job4.setJarByClass(MainMapReduce3.class);

		job4.setReducerClass(ReduceCoppie.class);
		job4.setMapperClass(MapCoppie.class);
		job4.setOutputKeyClass(Text.class);
		job4.setOutputValueClass(Text.class);

		Path pathFromJ3 = new Path(args[2]+ "/job3/part-r-00000");
		Path outputJob4 = new Path(args[2]+ "/job4");

		FileInputFormat.addInputPath(job4, pathFromJ3);
		FileOutputFormat.setOutputPath(job4, outputJob4);

		outputPath.getFileSystem(conf).delete(outputJob4);
